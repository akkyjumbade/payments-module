<template>
  <form @submit.prevent="onSubmit" class="dth_recharge_form">
      ...
      <div class="row">
          ...
          <div class="form-group">
            ...
            <select v-model="values.operator" name="operator" id="operator" class="form-control">
              ...
              <option
                ...
                :key="i" :value="option.id" v-text="option.name"
              ></option>
            </select>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input v-model="values.customer_id" name="customer_id" class="form-control" />
          </div>
        </div>
        <div class="col-sm-2">
          <div class="form-group">
